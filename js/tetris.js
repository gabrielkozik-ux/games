window.gameInstances.tetris = {
    ...
    ctx: null, grid: [], score: 0, gameOver: false, paused: false, loop: null, dropCounter: 0, dropInterval: 1000, lastTime: 0, cols: 12, rows: 20, blockSize: 0,
    ...
    handleInput(e) { if (window.activeGame !== 'tetris' || this.paused || this.gameOver) return; if (e.key === 'ArrowLeft') this.playerMove(-1); else if (e.key === 'ArrowRight') this.playerMove(1); else if (e.key === 'ArrowDown') this.playerDrop(); else if (e.key === 'ArrowUp') this.playerRotate(1); },
